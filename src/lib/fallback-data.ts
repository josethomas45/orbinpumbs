...
export const fallbackProducts: Record<string, Product[]> = {
  ...
  "solar-pumps": [
    ...
    {
      _id: "prod-sp-2",
      title: "ORBIN Cutter Pump",
      modelNumber: "OBJS Series",
      slug: { current: "cutter-pump" },
      shortDescription:
        "Heavy-duty cutter pump for domestic and industrial waste water management with high cutting efficiency.",
      features: [
        ...
        "Suitable for sewage and waste water",
      ],
      specifications: [
        { model: "OBJS-0.5", hp: "0.5", kw: "0.37", stages: "1", dischargeLpm: "100", headMeters: "10" },
        { model: "OBJS-10", hp: "10", kw: "7.5", stages: "1", dischargeLpm: "500", headMeters: "30" },
      ],
      images: [],
      series: "OBJS",
      hpRange: "0.5 - 10",
